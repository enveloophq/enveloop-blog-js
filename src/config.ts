...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    title: 'Enveloop',
    // site subtitle
    subtitle: 'Design, host, and send emails and texts.',
    // site description
  ...
  global: {
    ...
    moreLocales: ['es', 'ja', 'ru', 'zh-tw'], // ['de', 'en', 'es', 'fr', 'ja', 'ko', 'pl', 'pt', 'ru', 'zh-tw']
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/enveloophq',
      },
      {
        name: 'Email',
        url: 'hey@enveloop.com',
      },
      // {
      //   name: 'X',
